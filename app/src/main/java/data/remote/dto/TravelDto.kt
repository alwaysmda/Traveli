...
data class TravelDto(
    ...
    companion object {
        fun getFake() = TravelDto(Random.nextInt(1000), "Caribbean Sea", carabianSeeImage, CountryDto(0, "Iran", ""), false, 2000, TravelDetailDto.getFakes(), CityDto.getFakes(), UserPreviewDto.getFake())
