...
sealed class TravelDetail(
    ...
    data class Video(val title: String?, val video: String, val description: String?, val image: String = "https://www.konnecthq.com/wp-content/uploads/2019/07/Caribbean-Sea-31-12-1.jpg") : TravelDetail(VIEW_TYPE_VIDEO)
    ...
    data class Tag(val tag: String) : TravelDetail(VIEW_TYPE_TAG)
